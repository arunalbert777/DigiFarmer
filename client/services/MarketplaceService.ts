...
export class MarketplaceService {
  ...
  async getProducts(
    ...
    return this.apiService.getPaginated<Product>(
  ...
  async getMyProducts(
    ...
    return this.apiService.getPaginated<Product>(
      `/marketplace/farmers/${farmerId}/products`,
      page,
      limit,
    );
  }
  ...
  async getFeaturedProducts(limit?: number): Promise<ApiResponse<Product[]>> {
    return this.apiService.get<Product[]>("/marketplace/products/featured", {
      limit,
    });
  }
  ...
  async searchProducts(
    ...
    return this.apiService.get<Product[]>("/marketplace/products/search", {
      q: query,
      limit,
    });
  }
  ...
  async toggleLike(
    id: string,
  ): Promise<ApiResponse<{ liked: boolean; totalLikes: number }>> {
    return this.apiService.post<{ liked: boolean; totalLikes: number }>(
      `/marketplace/products/${id}/like`,
      {},
    );
  }
  ...
  getProductsMock(): Product[] {
    ...
    const productTemplates = [
      ...
      },
      {
        ...
        description:
          "Sweet and juicy Alphonso mangoes directly from Karnataka farms. Limited season availability.",
      ...
      },
      {
        ...
        description:
          "Pure cow milk delivered fresh every morning. Rich in nutrients and completely natural.",
      ...
      },
      {
        ...
        description:
          "Long grain basmati rice with excellent aroma and taste. Aged for perfect texture.",
      ...
      },
      {
        ...
        description:
          "Fresh green organic spinach leaves. Rich in iron and vitamins. Perfect for healthy meals.",
        category: "Vegetables" as const,
        price: 15,
        unit: "piece" as const,
        quantity: 50,
      ...
      },
      {
        ...
        description:
          "Pure red chili powder made from sun-dried chilies. No artificial colors or preservatives.",
      ...
      },
      {
        ...
        description:
          "Fresh tender coconuts with sweet water. Perfect for drinking and cooking.",
        category: "Fruits" as const,
        price: 25,
        unit: "piece" as const,
        quantity: 100,
      ...
      },
      {
        ...
        description:
          "Premium quality black gram dal. Rich in protein and perfect for South Indian dishes.",
    ...
    return productTemplates.map((template, index) => {
      ...
      harvestDate.setDate(
        harvestDate.getDate() - Math.floor(Math.random() * 7),
      );
