      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <TabsList className="grid w-full grid-cols-5 mb-8">
            ...
            >
              ...
              <span className="hidden sm:inline">
                {t("verticalFarming.benefitsLabel")}
              </span>
            </TabsTrigger>
            <TabsTrigger
              value="systems"
          ...
          <TabsContent value="overview" className="space-y-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Discover the advantages of vertical farming technology for
                modern agriculture
              </p>
            </div>
                ...
                return (
                  ...
                  >
                    <CardContent className="p-6">
                      <div
                        className={`inline-flex items-center justify-center w-12 h-12 rounded-lg ${benefit.bgColor} mb-4`}
                      >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <div className="font-semibold text-gray-900">
                      {t("verticalFarming.roi.timeframe")}
                    </div>
                  </div>
                  <div className="text-center">
                    <DollarSign className="h-8 w-8 text-blue-600 mx-auto mb-2" />
                    <div className="font-semibold text-gray-900">
                      {t("verticalFarming.roi.savings")}
                    </div>
                  </div>
                  <div className="text-center">
                    <TrendingUp className="h-8 w-8 text-purple-600 mx-auto mb-2" />
                    <div className="font-semibold text-gray-900">
                      {t("verticalFarming.roi.income")}
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <TabsContent value="systems" className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Choose the right vertical farming system for your needs and
                space
              </p>
            </div>
          ...
          <TabsContent value="setup" className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Follow our step-by-step guide to set up your vertical farming
                system
              </p>
            </div>
          ...
          <TabsContent value="costs" className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Choose the right investment level for your vertical farming
                goals
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  description: t(
                    "verticalFarming.costs.intermediate.description",
                  ),
                ...
                },
                {
                  ...
                  description: t(
                    "verticalFarming.costs.commercial.description",
                  ),
                ...
                <Card
                  key={index}
                  className={`text-center hover:shadow-lg transition-shadow ${index === 1 ? "ring-2 ring-primary" : ""}`}
                >
                  <CardHeader>
                    {index === 1 && (
        ...
        <div className="mt-16 text-center bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-2xl p-8">
          ...
          <p className="mb-6 max-w-2xl mx-auto opacity-90">
            Join the future of agriculture with space-efficient, sustainable
            vertical farming technology. Get expert guidance and support from
            local Bengaluru providers.
          </p>
