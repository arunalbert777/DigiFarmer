...
export function ContractFarming() {
  ...
  const localSupport = [
    {
      ...
      description:
        "Certified seeds, fertilizers, and pesticides at subsidized rates",
  ...
  const getContractTypeLabel = (type: string) => {
    switch (type) {
      case "seasonal":
        return t("contractFarming.contractTypes.seasonal");
      case "annual":
        return t("contractFarming.contractTypes.annual");
      case "multiYear":
        return t("contractFarming.contractTypes.multiYear");
      default:
        return type;
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <TabsContent value="companies" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {Object.entries(t("contractFarming.localCompanies") || {}).map(
                ([key, company]: [string, any]) => (
        ...
        <div className="mt-16 text-center bg-primary/5 rounded-2xl p-8">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Join thousands of farmers in Bengaluru who have improved their
            income and reduced risks through contract farming partnerships.
          </p>
