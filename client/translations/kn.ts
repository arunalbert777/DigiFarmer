export default {
  ...
  home: {
    ...
    features: {
      diseaseDetection: {
        title: 'AI ರೋಗ ಪತ್ತೆ',
        description: 'ಸುಧಾರಿತ AI ತಂತ್ರಜ್ಞಾನವನ್ನು ಬಳಸಿಕೊಂಡು ತ್ವರಿತ ರೋಗ ಗುರುತಿಸುವಿಕೆ ಮತ್ತು ಚಿಕಿತ್ಸೆ ಶಿಫಾರಸುಗಳಿಗಾಗಿ ಬೆಳ�� ಚಿತ್ರಗಳನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ.',
      },
      aiAssistant: {
        title: 'AI ಸಹಾಯಕ',
  ...
  marketplace: {
    ...
    addProduct: {
      ...
      form: {
        ...
        uploadImages: 'ಚಿತ್ರಗಳನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಲು ಕ್ಲಿಕ್ ಮಾಡಿ ಅಥವಾ ಡ್ರ್ಯಾಗ್ ಮತ��ತು ಡ್ರಾಪ್ ಮಾಡಿ',
        tooManyImages: 'ಹೆಚ್ಚು ಚಿತ್ರಗಳು',
        maxImagesError: 'ನೀವು ಗರಿಷ್ಠ 5 ಚಿತ್ರಗಳನ್ನು ��ಪ್‌ಲೋಡ್ ಮಾಡಬಹುದು',
