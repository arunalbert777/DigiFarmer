export default {
  ...
  verticalFarming: {
    title: 'Vertical Farming',
    subtitle: 'Maximize your yield with space-efficient vertical farming technologies and local Bengaluru solutions',
    ...
    setupGuide: {
      ...
      step1: {
        ...
        description: 'Assess your available space and choose the right system size',
        details: 'Indoor space, balcony, terrace, or dedicated room - minimum 4x4 feet required',
      },
      step2: {
        title: 'System Selection',
        description: 'Choose between hydroponic, aeroponic, or media-based systems',
        details: 'Consider crops, budget, and maintenance requirements',
      },
      step3: {
        title: 'Equipment Installation',
        description: 'Install grow lights, pumps, timers, and monitoring systems',
        details: 'LED lights, nutrient pumps, pH meters, and automation systems',
      },
      step4: {
        title: 'Crop Selection',
        description: 'Start with easy crops like lettuce, herbs, and microgreens',
        details: 'Gradually expand to tomatoes, peppers, and strawberries',
      },
      step5: {
        title: 'Monitoring & Maintenance',
        description: 'Regular monitoring of pH, nutrients, and environmental conditions',
        details: 'Daily checks, weekly nutrient changes, and system maintenance',
      },
    },
    localProviders: {
      futurefarms: {
