...
const imageUrl =
  "https://cdn.builder.io/api/v1/image/assets%2F9a08e76889074a27806519bd7e3ac637%2F4dcfa529482f4beca23a7e1afe3a46ea?format=webp&width=800";
  ...
  return new Promise((resolve, reject) => {
    ...
    get(url, (res) => {
      if (res.statusCode && res.statusCode >= 400)
        return reject(
          new Error("Failed to fetch image, status " + res.statusCode),
        );
      const chunks = [];
